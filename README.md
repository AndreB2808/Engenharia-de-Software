...
O projeto recebeu uma atualização que além de constar com um sistema simples de cadastro e login utilizando de arquivo JSON, também foi implementada uma simples interface utilizando de ???
