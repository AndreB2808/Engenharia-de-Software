...
Para o funcionamento do serviço Servatio, será necessária a criação de uma aplicação capaz de gerenciar as informações financeiras dos usuários, além de possibilitar a conexão com serviços financeiros externos. Durante o desenvolvimento do projeto, os dados e serviços necessários poderão ser simulados para representar o funcionamento da aplicação sem a necessidade de integrações reais. Porém, na fase atual do projeto, apenas a ideia / proposta será oferecida.
