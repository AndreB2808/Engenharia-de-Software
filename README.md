...
O projeto recebeu uma atualização que além de constar com um sistema simples de cadastro e login utilizando de arquivo JSON, também foi implementada uma simples interface utilizando de Streamlit
...
## ⭐ Diferencial
Foi escolhida a implementação de uma opção de escolher entre tema claro e escuro para a interface, justamente pela implementação da prototipagem da interface básica.
